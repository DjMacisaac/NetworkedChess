...
#let rdt recv get an instance of the board
receiver = Receiver(board)
ip, port = receiver.getAddress()
board.sendRecvAddress(ip,port)
while(receiver.hasFoundGame == False):
    pass
receiver.initializeReceiverThread
